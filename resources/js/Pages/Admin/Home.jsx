        ...
        <>
            ...
            <div className='px-10'>
                <div className='w-3/5 m-auto'>
                    <p class="my-4 text-4xl font-semibold text-center">Hai Admin, Selamat Datang di iFile</p>
                            ...
                            <div className='flex justify-between w-full p-4 rounded-md shadow-md shadow-i-pink-500/20'>
                                <div className='flex flex-col items-center gap-4 mb-4 text-center'>
                                    ...
                                    <a href={route('kategori.show', k.kategori)}
                                        className="w-full px-4 py-2 text-center text-white text-gray-600 truncate rounded-md hover:text-gray-900 focus:bg-i-pink-500/60 bg-i-pink-500">
                                        Lihat Kategori
                                    </a>
                                </div>
                            </div>
